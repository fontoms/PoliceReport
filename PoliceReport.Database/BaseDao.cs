...
namespace PoliceReport.Database
{
    public abstract class BaseDao
    {
        ...
        /// <summary>
        /// Map SQLite type to C# type
        /// </summary>
        /// <param name="sqliteType">SQLite type</param>
        ...
        private void CreateDatabase()
        {
            if (connection == null)
            {
                ...
                foreach (string createQuerie in createTableQueries)
                    _databaseConnection.ExecuteNonQuery(createQuerie);
            }
        }
        ...
        private void InsertDatabase()
        {
            ...
            foreach (string insertTable in insertTableQueries)
                _databaseConnection.ExecuteNonQuery(insertTable);
        }
        #endregion
    }
}
